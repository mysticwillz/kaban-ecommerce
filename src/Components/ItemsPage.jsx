...
function ItemsPage() {
  return (
    ...
    <main className="bg-white max-w-7xl mt-[15px] mx-auto h-[70%]">
        ...
        <section className='w-[80%] flex justify-between items-center md:pr-2'> 
            <div className='flex flex-col w-[30%] '>
                <img src='https://ng.jumia.is/unsafe/fit-in/500x500/filters:fill(white)/product/95/990758/1.jpg?6073' alt='item' className='w-full px-2 py-4'/>
            ...
            <div className=' px-2 '>
                ...
                ENS Smart Unisex Classic White Sneakers
                </h1>
                <div className='mt-[15px] '>
                    ...
                    <p className='text-[25px] text-bolder'>$ 10000</p>
                    <p className='text-[18px] font-bold  bolder'>$ <strike>5000</strike>
                    </p>
      ...
      <section className='w-[60%] py-2 px-4'>
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae cum sapiente, iusto, nulla eligendi autem ut illum aut voluptatum quis adipisci? Esse earum omnis magni quasi quis asperiores doloremque reiciendis.    
        </p>
      </section>
