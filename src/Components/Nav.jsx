   ...
   <div className='w-full text-[#424b52] h-2xl bg-[#fff] shadow-lg '>
     <nav className='max-w-6xl flex justify-between items-center mx-auto p-4'>
        ...
        <form onSubmit={handleSubmit} className='relative flex items-center '>
           ...
           <button className=' shadow ml-[10px] uppercase mx-auto  md:w-[9rem] py-[10px] px-[15px] bg-[#1e6091] text-white rounded h-[40px] flex items-center justify-center cursor-pointer transition duration-150 ease-in-out hover:bg-[#102f47]'> search </button>
        </form>
       
       
        <div onClick={()=>{
          navigate("/login")
        }} className='flex justify-between items-center cursor-pointer m-[5px] hover:text-[#1e6091]'>
        ...
        <div onClick={()=>{
          navigate("/cart")
        }} className='flex cursor-pointer items-center hover:text-[#1e6091]'>
