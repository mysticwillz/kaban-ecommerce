    ...
    <section className="max-w-7xl mx-auto ">
      <div className="flex flex-col justify-between mx-auto h-[250px] md:h-[300px] bg-white  mt-[10px] ">
        <div className="w-full bg-[#1e6091] rounded-t-sm">
          <h1 className="text-center text-white text-[20px] md:text-[30px]  capitalize">
            {" "}
            top selling items{" "}
          </h1>
        </div>
          ...
          >
            {topSelling.map((data) => {
              ...
              return (
                <SwiperSlide
                  key={id}
                  className="flex flex-col items-center  product-div shadow-light-50 "
                >
                  <div className="h-full">
                    <img src={img} alt="top selling " className=" h-[65%]" />
                    <div className=" h-auto">
                      <p className="text-bold] px-1">{name}</p>
                      <p className=" text-[12px] md:text-[14px px-1">
                        ${price}
                      </p>
                      <strike className=" px-1 pb-1 text-[10px] md:text-[12px] text-warm-gray-400">
                        ${price * 2}
                      </strike>
                    </div>
                  </div>
      ...
      <div className="w-full flex flex-col h-[250px] md:h-[300px] bg-white mt-[10px]">
        <div className="w-full bg-[#1e6091] h-[20%] flex items-center justify-center rounded-t-sm">
          <h1 className="text-center text-[20px] md:text-[30px] text-white   capitalize">
            Kaban universal week
          </h1>
        </div>
        ...
        <div className=" flex justify-between  ">
          {kabanWeek.map((data) => {
            ...
            return (
              <div
                key={id}
                className=" flex justify-between text-white mb-[15px] items-center flex-wrap"
              >
